...
<p align="center">
<img src="https://github.com/janssen-io/foundry-token-hotbar/workflows/TokenHotbar%20CI/badge.svg" alt="build status" /> <img src="https://img.shields.io/github/downloads-pre/janssen-io/foundry-token-hotbar/v3.3.1/TokenHotbar.zip?label=v3.3.1" alt="v3.3.1 downloads" /> <img src="https://img.shields.io/github/downloads-pre/janssen-io/foundry-token-hotbar/v3.3.1-beta/TokenHotbar.zip?label=v3.3.1-beta" alt="v3.3.1-beta downloads" />
</p>
